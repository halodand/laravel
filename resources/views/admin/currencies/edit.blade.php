                    ...
                    <form method="POST" action="{{ route("admin.currencies.update", [$currency->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('jenis') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Currency::JENIS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jenis_{{ $key }}" name="jenis" value="{{ $key }}" {{ old('jenis', $currency->jenis) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('nama') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $currency->nama) }}" required>
                            @if($errors->has('nama'))
                        ...
                        <div class="form-group {{ $errors->has('jual') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="jual" id="jual" value="{{ old('jual', $currency->jual) }}" step="0.01" required>
                            @if($errors->has('jual'))
                        ...
                        <div class="form-group {{ $errors->has('beli') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="beli" id="beli" value="{{ old('beli', $currency->beli) }}" step="0.01" required>
                            @if($errors->has('beli'))
                        ...
                        <div class="form-group {{ $errors->has('diskon') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="diskon" id="diskon" value="{{ old('diskon', $currency->diskon) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('no_currency') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_currency" id="no_currency" value="{{ old('no_currency', $currency->no_currency) }}">
                        ...
                        <div class="form-group {{ $errors->has('nama_currency') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama_currency" id="nama_currency" value="{{ old('nama_currency', $currency->nama_currency) }}">
                        ...
                        <div class="form-group {{ $errors->has('min_trans') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min_trans" id="min_trans" value="{{ old('min_trans', $currency->min_trans) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('max_trans') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="max_trans" id="max_trans" value="{{ old('max_trans', $currency->max_trans) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Currency::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $currency->status) === (string) $key ? 'checked' : '' }}>
