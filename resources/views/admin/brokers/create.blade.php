        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.broker.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.brokers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('judul_kat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="judul_kat" id="judul_kat" value="{{ old('judul_kat', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('judul_perusahaan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="judul_perusahaan" id="judul_perusahaan" value="{{ old('judul_perusahaan', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('kantor_pusat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="kantor_pusat" id="kantor_pusat" value="{{ old('kantor_pusat', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('tahun_berdiri') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tahun_berdiri" id="tahun_berdiri" value="{{ old('tahun_berdiri', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('badan_regulasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="badan_regulasi" id="badan_regulasi" value="{{ old('badan_regulasi', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('profil') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="profil" id="profil">{!! old('profil') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('jenis_akun') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="jenis_akun" id="jenis_akun">{!! old('jenis_akun') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('deskripsi_tambahan') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="deskripsi_tambahan" id="deskripsi_tambahan">{!! old('deskripsi_tambahan') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('kondisi_trading') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="kondisi_trading" id="kondisi_trading">{!! old('kondisi_trading') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('ket_broker') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="ket_broker" id="ket_broker">{!! old('ket_broker') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('rebate_auto_manual') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="rebate_auto_manual" id="rebate_auto_manual">
                                ...
                                @foreach(App\Models\Broker::REBATE_AUTO_MANUAL_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('rebate_auto_manual', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('link_broker') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="link_broker" id="link_broker" value="{{ old('link_broker', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('kurs_depo') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kurs_depo" id="kurs_depo" value="{{ old('kurs_depo', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('kurs_wd') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kurs_wd" id="kurs_wd" value="{{ old('kurs_wd', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('stok') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="stok" id="stok" value="{{ old('stok', '') }}" required>
                            @if($errors->has('stok'))
                        ...
                        <div class="form-group {{ $errors->has('no_broker') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_broker" id="no_broker" value="{{ old('no_broker', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nama_broker') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama_broker" id="nama_broker" value="{{ old('nama_broker', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('status_transaksi') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Broker::STATUS_TRANSAKSI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_transaksi_{{ $key }}" name="status_transaksi" value="{{ $key }}" {{ old('status_transaksi', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('min_transaksi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min_transaksi" id="min_transaksi" value="{{ old('min_transaksi', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('max_transaksi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="max_transaksi" id="max_transaksi" value="{{ old('max_transaksi', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('komisi_ib') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="komisi_ib" id="komisi_ib" value="{{ old('komisi_ib', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('komisi_pemilik') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="komisi_pemilik" id="komisi_pemilik" value="{{ old('komisi_pemilik', '') }}">
